...
$(function () {
    ...
    // $("#language option[value=" + i18nLanguage + "]").prop("selected", true);
    // return;
    var languageArr = $('#language').find('a');
    $.each(languageArr, function (i, val) {
        if(i18nLanguage == $(this).attr('value')){
            $('.languageText').text($(this).text());
        };
    });

    /* Choose a language */
    $('#language li').click(function () {
        var language = $(this).children('a').attr('value');
