...
<head>
    ...
    <title class="i18n" name="errorTitle"></title>
...
<section>
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <h1 class="i18n" name="errorSelectDatabase"></h1>
            </div>
            <div class="col-md-12 col-sm-12">
                <div class="textBox">
                    <p class="i18n" name="errorMessageOne"></p>
                    <ul>
                        <li class="i18n" name="errorMessageTwo"></li>
                        <li class="i18n" name="errorMessageThree"></li>
                        <li class="i18n" name="errorMessageFour"></li>
                    </ul>
                    <p class="i18n" name="errorMessageFive"></p>
