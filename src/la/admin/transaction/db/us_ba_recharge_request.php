...
//======================================
// 函数: 获取us_ba_recharge_request基本信息
// 参数: $ba_id                      用户ba_id
// 返回: $row                        基本信息数组
//         asset_id                 充值资产ID
//         bit_amount               数字货币金额
...
//======================================
function  get_ba_recharge_log_balance()
{
    $db = new DB_COM();
...
//         ba_account_id            代理商账号ID（Hash）
//======================================
function  get_us_ba_recharge_log_balance()
{
    $db = new DB_COM();
    $sql = "SELECT * FROM us_ba_recharge_request";
    $db -> query($sql);
...
function get_us_ba_recharge_log_balance_limt($from_time,
                                             $to_time,
                                             $ba_id,
                                             $qa_id,
                                             $us_id,
                                             ...
                                             $tx_hash)
{
    ...
    if($ba_account_id){
        if($where){
            $where .= "AND ba_account_id = '{$ba_account_id}' ";
        }else{
    ...
    $db = new DB_COM();
    if($where){
        $sql = "SELECT * FROM us_ba_recharge_request where  $where";
    }else{
        $sql = "SELECT * FROM us_ba_recharge_request";
    }
