...
require_once "../inc/transaction_order/la_ba_recharge_confirm.php";
require_once "../inc/transaction_order/la_ca_recharge_confirm.php";
...
if ($rows["tx_type"] == "BA"){
    base_ba_recharge_confirm($rows);
}elseif ($rows["tx_type"] == "CA"){
    base_ca_recharge_confirm($rows);
}
