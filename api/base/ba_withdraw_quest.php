...
require_once "../inc/transaction_order/la_ba_withdraw.php";
...
if(!get_pass_hash($ba_id))
    exit_error('106','资金密码未绑定');
if(get_pass_hash($ba_id) == $fun_pass)
...
$bit_address_row = get_ba_bind_bit_address($ba_id);
